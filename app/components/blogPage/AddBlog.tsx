...
const AddBlog = () => {
    ...
    const onSubmit: SubmitHandler<Inputs> = async (data) => {
        if(image){
            ...
            await manageBlogImageUpload(formData)
        }
        // const content = JSON.stringify(editorState)
        // const response = await createBlog(data.title, content,image)
    ...
    useEffect(() => {
        ...
        const timeoutId = setTimeout(handleRequest, 2000);
                        ...
                        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start flex-col gap-3">
                                    <div className="flex items-center justify-center w-full">
                                        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                            <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                                ...
                                                <p className="text-xs text-gray-500 dark:text-gray-400">Include a high-quality image in your story to make it more inviting to readers.</p>
                                            </div>
                                    ...
                                    {categoryData.length >= 1 && <div className='w-full'>
                                        <p>dwd</p>
                                        <p>dwd</p>
                                    </div>}
